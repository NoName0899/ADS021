...
class MoradorSeeder extends Seeder
{
    ...
    public function run(){
        DB::table('moradores')->insert([
            ...
            ['id'=>'3', 'cpf'=>'222.222.222-22','nome'=>'Caio Isidio', 'email'=>'caio@iesb.br', 'telefone'=>'(22)22222-2222','marca'=>'Mercedes', 'veiculo'=>'C180', 'placa'=>'CCC-2222', 'situacao'=>'Ativo', 'condominio_id'=>'1', 'unidade_id'=>'1']
        ]);
    }
}
